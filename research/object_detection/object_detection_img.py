...
os.chdir('~/manhole/models/research/object_detection/')
...
PATH_TO_TEST_IMAGES_DIR = '~/manhole/models/research/object_detection/garbage_test_img/'
...
output_image_path = ('~/manhole/models/research/object_detection/garbage_test/')
output_csv_path = ('~/manhole/models/research/object_detection/garbage_test/')
