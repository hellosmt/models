...
os.chdir('/root//manhole/models/research/object_detection/')
...
MODEL_NAME = 'garbage_inference_graph'
...
PATH_TO_LABELS = os.path.join('data', 'garbage.pbtxt')
...
output_path = ('/root/manhole/models/research/object_detection/garbage_test/')
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        vidcap = cv2.VideoCapture('/root/manhole/models/research/object_detection/garbage_test/test.mp4')
        ...
        out_video = cv2.VideoWriter('outpy.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 10,
